...
\phone[mobile]{+1 (408) 593 8097}                         % opcional, remover o comentar si no quiere incluir su número de móvil
...
I believe I could become an asset for this company, as shown in my CV, I have a full Software Engineer background, algorithms, data structures and complexity are part of my day to day worries and in the last two years I have studied them. But what really moves me, the things I love to study just for the sake of it, is the formal background you can find in all this, the idea of having an implementation that's been prooved correctly, not being able to draw a clear line between programs and theorems, it's crazy.

Also, I have some prior Haskell experience have gained a lot working as a Teacher Assistant in a Haskell course. While regarding Git, I've been using it for both personal and university related projects for the last couple of years.

What I'd expect from an internship at Galois is to learn a lot in an environment where formal CS functions very closely to implementations and real world problems. I don't think there are a lot of places out there where that combination is so clear.

To work in the US, I'd need a J1 (or similar) Visa, I've gotten one in the past (to work at Google) and didn't have any problems with it.
