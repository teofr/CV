...
\langs{Current GPA}{Promedio Actual}: 9.64 \langs{\hfill{\em On a 10 point scale}}{}
...
{}
\item[] \langs{Completed a Software Engineering Internship at Google for the Summer 2018. Worked on an A/B performance test for a server responsible of authorizing and optimizing reads from a database, the project lowered the noise on these tests from 20\% to 5\%.}
