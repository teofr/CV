...
\item \langs{Competed on the ACM - ICPC South America/South regional contest 2016 and ended 7th (2nd on our university). 
...
\item \langs{Active participation since March 2016 on a reading group about $\lambda$-calculus, rewriting, type theory and much more. 
\footnote{A translation can be made upon request.  \url{https://sites.google.com/site/labandalambda/} }}
{Pariticipación activa desde Marzo del 2016 en un grupo de lectura sobre cálculo-$\lambda$, reescritura, teoría de tipos y mucho más.
...
\item \langs{Worked as a TA on a Data structures and algorithms course in my university.}{Trabajó como ayudante en una materia sobre algoritmos y estructuras de datos.}

\item \langs{We teach an introduction on algorithms and data structures and a refinement on formal software specification and correctness.}{Se enseña una introducción a distintos algoritmos y estructuras de datos y un refinamiento sobre correctitud y especificación formal de software.}
\end{rSubsection}
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
\langs{Written English}{Inglés escrito}			& \langs{Fluid}{Fluido} \\
\langs{Spoken English}{Inglés hablado}			& \langs{Fluid}{Fluido} \\
