...
\address{\texttt{tfreund95@gmail.com} \\ \href{https://github.com/teofr}{\texttt{github.com/teofr}} \\ \href{https://www.linkedin.com/in/teodoro-freund/}{\texttt{linkedin.com/in/teodoro-freund}}}
...
\item \langs{Active participation since March 2016 on a reading group about $\lambda$-calculus, rewriting, type theory and related subjects.
\footnote{A translation can be made upon request.  \href{https://labandalambda.github.io/}{\texttt{labandalambda.github.io}} }}
{Pariticipación activa desde Marzo del 2016 en un grupo de lectura sobre cálculo-$\lambda$, reescritura, teoría de tipos y otros temas relacionados.
...
{Compitió en las regionals de Sudamérica de la ACM - ICPC en los años 2016, 2017 and 2018, alcanzando y compitiendo en la 43 ICPC World Finals en 2019\footnote{El nombre de nuestro equipo es El Bueno, el Ralo y el Feo. \\href{https://icpc.baylor.edu/ICPCID/MPJ2YWYRR35P}{\texttt{icpc.baylor.edu/ICPCID/MPJ2YWYRR35P}}}}
...
{}
\item[] \langs{Completed a Software Engineer Internship at Tweag I/O\footnote{\href{https://www.tweag.io/}{\texttt{tweag.io}}}. Worked on prototyping a new version of a functional programming language, with the main new feature being a gradual typing and contract-based runtime type verification system. Some of the techniques I used for rapid experimentation can be found on my blog post \\
\href{https://www.tweag.io/blog/2019-11-28-PCF-makam-spec/}{\texttt{tweag.io/blog/2019-11-28-PCF-makam-spec}}.}
{Completó una pasatía en ingeniería de Software en Tweag I/O\footnote{\href{https://www.tweag.io/}{\texttt{tweag.io}}}. Trabajó en prototipar una nueva versión de un lenguaje de programación funcional, donde la principal novedad es agregarle un sistema de tipos gradual con verificación de tipos en tiempo de ejecución usando contratos. Algunas de las técnicas que utilizó para experimentar rapidamente se pueden leer en mi blog post \\
\href{https://www.tweag.io/blog/2019-11-28-PCF-makam-spec/}{\texttt{tweag.io/blog/2019-11-28-PCF-makam-spec}}.}
\end{rSubsection}
...
{Completó una pasantía en Facebook como ingeniero de software, durante el verano de 2019. Trabajó extendiendo un servicio de invalidación de cache en tiempo real para soportar más de un tipo de bases de datos al mismo tiempo. Además, dio soporte a una base de datos interna de tipo \texttt{key:value} como prueba de concepto.}
\end{rSubsection}
...
{}
\item[] \langs
{Worked as a TA on two courses, an introductory course on Haskell and functional programming. And an algorithms and data structures course, where the main focus was on some classic algorithms and data structures, as well as a basis on formal software specification.}
{Trabajó como ayudante en dos cursos, un curso introductorio sobre Haskell y programación funcional. Y otro de algoritmos y estructuras de datos, donde el foco principal era estudiar algoritmos y estructuras clásicos, y enseñar las bases de un sistema de especificación formal de software.}
\end{rSubsection}
